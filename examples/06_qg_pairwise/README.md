# Pairwise quantum geometry

Berry curvature, quantum metric, and their ordered interband counterparts.
...
|---|---|---|---:|---:|---|---|---|
| `berry_curvature_conventional.jl` | `berry_curvature` | `conventional` | 200×200 | None | `(1,2)` | `{"subspace":[19,20]}` | no |
| `quantum_metric_conventional.jl` | `quantum_metric` | `conventional` | 200×200 | None | `(2,2)` | `{"subspace":[19,20]}` | no |
| `interband_berry_curvature_conventional.jl` | `interband_berry_curvature` | `conventional` | 200×200 | None | `(1,2)` | `{"second":[19,20],"first":[21,22]}` | no |
| `interband_quantum_metric_conventional.jl` | `interband_quantum_metric` | `conventional` | 200×200 | None | `(2,2)` | `{"second":[19,20],"first":[21,22]}` | no |
...
```bash
julia --project=. examples/06_qg_pairwise/run.jl --profile=smoke
julia --project=. examples/06_qg_pairwise/run.jl --profile=reference
...
```bash
julia --project=. examples/06_qg_pairwise/cases/berry_curvature_conventional.jl --profile=smoke
julia --project=. examples/06_qg_pairwise/cases/quantum_metric_conventional.jl --profile=smoke
julia --project=. examples/06_qg_pairwise/cases/interband_berry_curvature_conventional.jl --profile=smoke
julia --project=. examples/06_qg_pairwise/cases/interband_quantum_metric_conventional.jl --profile=smoke
```
...
- `kslice_berry_curvature_conventional`: `GeS_bck_subspace_19_20_conv.dat`
- `kslice_quantum_metric_conventional`: `GeS_qmk_subspace_19_20_conv.dat`
- `kslice_interband_berry_curvature_conventional`: `GeS_ibck_conv.dat`
- `kslice_interband_quantum_metric_conventional`: `GeS_iqmk_conv.dat`
